...
const products = [
  ...
  },
  {
    ...
    stock: 18,
    relatedProducts: [3, 4, 10],
  },
  {
    id: 10,
    name: "Yonex Power Cushion Insole",
    description: "Specialized insoles for badminton shoes that enhance shock absorption and comfort.",
    longDescription: `
      The Yonex Power Cushion Insoles are specifically designed to enhance the performance and comfort of your badminton footwear. These specialized insoles utilize Yonex's proprietary Power Cushion technology, which provides 3 times better shock absorption than standard insoles while delivering 5% more power return with each step.

      The anatomically designed arch support helps maintain proper foot alignment during lateral movements, reducing strain on your feet and ankles. The breathable top layer wicks away moisture to keep your feet dry, while the antibacterial treatment helps prevent odors even after intense training sessions.

      These insoles are perfect for players who experience foot fatigue during long matches or training sessions, or for those looking to extend the life of their badminton shoes by upgrading the cushioning system. Compatible with most badminton shoe models, these insoles can be easily trimmed to ensure a perfect fit.
    `,
    price: 25.0,
    originalPrice: 35.0,
    rating: 4.5,
    ...
    category: "Accessories",
    features: [
      "Power Cushion technology for superior shock absorption",
      "Anatomical arch support",
      "Breathable, moisture-wicking top layer",
      "Antibacterial treatment",
      "Trimmable design for custom fit",
    ],
    specifications: {
      material: "EVA foam with Power Cushion technology",
      sizes: "EU 38-47 (trimmable)",
      thickness: "5mm heel, 3mm forefoot",
      weight: "45g per pair",
      washable: "Hand wash with mild soap",
      compatibility: "Universal fit for most badminton shoes",
    },
    stock: 40,
...
const services = [
  ...
  },
  {
    ...
    image: "/images/badminton-court.png",
    price: 25,
    duration: "1 hour",
    availableTimes: [
      "8:00 AM",
  ...
  },
  {
    ...
    image: "/images/service-stringing.png",
    price: 20,
    duration: "Same day service",
    stringTypes: ["Yonex BG65", "Yonex BG80", "Li-Ning No.1", "Victor VS-850", "Ashaway Zymax"],
  },
  {
    id: 4,
...
// Export all data
export { products, bestsellerProducts, services, rentalItems, rentalPackages, blogPosts }
