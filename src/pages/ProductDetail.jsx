  ...
  return (
    <main className="min-h-screen bg-[#1e2535] py-12 px-4 sm:px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        <button variant="ghost" className="flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors h-10 px-4 py-2 text-white hover:text-yellow-400 mb-6" onClick={() => navigate('/product')}>
